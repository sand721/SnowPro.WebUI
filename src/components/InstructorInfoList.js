...
const InstructorInfoList = () => {
    ...
    return (
        <div>
            ...
            <button onClick={() => navigate(`/${navDashboard}/${navInstructorInfo}/create`)}>Add New Instructor</button>
            <table>
                <thead>
                <tr>
                    <th>Name</th>
                ...
                {instructor.map(instructor => (
                    <tr key={instructor.id}>
                        ...
                        <td>
                            <button onClick={() => navigate(`/${navDashboard}/${navInstructorInfo}/${instructor.id}/edit`)}>Edit</button>
